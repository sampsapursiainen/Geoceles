...
zef.h_geoceles = fopen('geoceles.ini');
zef.ini_cell = textscan(zef.h_geoceles,'%s');
...
zef_init;
zef.h_geoceles = open('geoceles.fig');
...
set(zef.h_visualization_type,'string',{'Structure','Recon. (volume)','Recon. (surface)'});
set(zef.h_pushbutton31,'string','Visualize volume')
zef.o_h = findall(zef.h_geoceles);
zef.h_axes2 = zef.o_h(365);
zef.h_axes1 = zef.o_h(366);
zef=rmfield(zef,'o_h');
zef.clear_axes1 = 0;
zef_update;
