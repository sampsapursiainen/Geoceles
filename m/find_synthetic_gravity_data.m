...
if ismac
zef.h_find_synthetic_source = open('find_synthetic_gravity_data_alt.fig');
elseif ispc
zef.h_find_synthetic_source = open('find_synthetic_gravity_data_alt2.fig');
else
zef.h_find_synthetic_source = open('find_synthetic_gravity_data.fig');
end
